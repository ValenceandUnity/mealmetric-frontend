...
export type ClientHistoryModeFilter = "all" | WorkoutLogMode;
...
export type MobileClientHistoryView = {
  ...
  olderEntriesLabel: string;
};

type SortableWorkoutLogRow = MobileClientWorkoutLogCardView & {
...
export function adaptClientHistoryView(value: JsonValue | null): MobileClientHistoryView {
  ...
  return {
    ...
    olderEntriesLabel:
      historyPage.hasMore && historyPage.nextOffset !== null ? "Older entries available" : "No older entries",
  };
}
