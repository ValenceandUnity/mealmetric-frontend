...
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    const data = await backendFetch<JsonValue>(`/pt/clients/${clientId}/meal-plan-recommendations`, {
      method: "POST",
      session,
      body,
    });
    ...
    return toApiErrorResponse(error, "Unable to create meal recommendation.");
  }
}
